...
namespace DoctrineORMModule\Proxy\__CG__\Auth\Model\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class HierarchicalRole extends \Auth\Model\Entity\HierarchicalRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'children', 'permissions');
        }
